...
> Chaque ligne disposant de données cartographiques valides est alors par défaut représentée sur le fond Carte Facile avec ce symbole : <img src="widget/marker.png" alt="Marker" style="heigt: 25%"/>. 
