...
<img class='no-change' src="assets/img/widget-control-instruction.png" alt="mode ajout"/>
...
<img class="no-change" src="assets/img/widget-form-addorupdate-add.png" alt="mode ajout"/>
...
<img class='no-change' src="assets/img/widget-form-addorupdate-select.png" alt="sélection de la ligne"/>
...
<img class='no-change' src="assets/img/widget-form-addorupdate-update.png" alt="mode actualisation"/>
...
<img class='no-change' src="assets/img/context-menu-not-hover.png" alt="menu contextuel hors marqueur"/>
...
<img class='no-change' src="assets/img/widget-form-add.png" alt="formulaire d'ajout"/>
...
<img class='no-change' src="assets/img/context-menu-hover.png" alt="menu contextuel sur marqueur"/>
...
<img class='no-change' src="assets/img/widget-form-add.png" alt="formulaire de mise à jour"/>
...
<img class='no-change' src="assets/img/widget-form-delete.png" alt="formulaire de suppression"/>
