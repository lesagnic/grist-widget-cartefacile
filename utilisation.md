...
L'outil Map libre fournit les fonctions de navigation de base (déplacement en bougeant la souris après un clic maintenu sur la carte) ainsi que zoom (<img height="18" src="assets/img/widget-control-zoom.png" alt="zoom"/>), dézoom (<img height="18" src="assets/img/widget-control-dezoom.png" alt="dezoom"/>) et orientation (<img height="18" src="assets/img/widget-control-orientation.png" alt="orientation"/>).
