...
L'outil Map libre fournit les fonctions de navigation de base (déplacement en bougeant la souris après un clic maintenu sur la carte) ainsi que zoom/dézoom/orientation en cliquant respectivement sur les boutons <img height="24" src="assets/img/widget-control-all-rows.svg" alt="zoom"/>.
